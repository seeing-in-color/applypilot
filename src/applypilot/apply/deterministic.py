...
from applypilot.apply.cdp_driver import (
    _ethnicity_token_overlap_match,
    _field_values_equivalent_for_skip,
)
from applypilot.apply.field_answers import normalize_school_name_for_forms
...
def try_apply_field_rules_to_selects(driver: "CdpPlaywrightDriver", profile: dict | None) -> int:
    ...
    from applypilot.apply.field_answers import match_answer_for_field
