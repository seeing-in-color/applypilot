...
from applypilot.apply.cdp_driver import CdpPlaywrightDriver
from applypilot.apply.dashboard import add_event, get_state, update_state
from applypilot.apply.deterministic import (
...
from applypilot.apply.field_answers import enrich_form_fields_json_with_profile, save_user_rule
from applypilot.apply.prompt import build_compact_apply_prompt
...
TOOLS = [
    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                "Save a regex pattern → answer for future runs (writes ~/.applypilot/field_answers.yaml). "
